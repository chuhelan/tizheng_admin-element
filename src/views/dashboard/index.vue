    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="leaveJob">加班离职</el-button>
...
import Rander from '@/views/dashboard/components/rander.vue'
...
export default {
  ...
  methods: {
    ...
    async btnOk() {
      ...
      await startProcess({ ...this.form, userId: this.userInfo.userId })
