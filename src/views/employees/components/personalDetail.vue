<template>
  <div class="user-info">
    ...
    <!-- 基础信息 -->
    <el-card shadow="always" :body-style="{ padding: '20px' }" style="margin-top:30px">
      <div slot="header">
        <span>基础信息</span>
      </div>
      <el-form label-width="220px">
...
import { getPersonalDetail, updatePersonal, saveUserDetailById, getUserDetailById } from '@/api/user'
export default ({
  data() {
    return {
