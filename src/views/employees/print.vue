    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="printObj" type="primary" size="default">打印</el-button>
        </el-row>
        <div id="myPrint">
...
<script>
import { getPersonalDetail, getJobDetail, getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
  ...
  methods: {
    ...
    async getJobDetail() {
      ...
      this.userInfo = data
      const res = await getJobDetail(this.userId) // 获取个人基本信息
      this.jobInfo = res.data
      this.formData = { ...this.userInfo, ...this.jobInfo }
    }
  }
}
</script>
